...
public class App {
    public static void main(String[] args) {
        try {
            ...
            printPadding();
            System.out.println("Timesheet kedua sudah approved. Data ini sekarang bisa dipakai untuk kontrak dan invoice");
            ...
            System.out.println("Operasi gagal karena aturan domain tidak terpenuhi: " + e.getMessage());
            System.out.println("[DOMAIN ERROR] " + e.getMessage());
        } catch (IllegalArgumentException e) {
            System.out.println("Operasi gagal karena input tidak valid: " + e.getMessage());
            System.out.println("[VALIDATION ERROR] " + e.getMessage());
        } catch (Exception e) {
            System.out.println("Operasi gagal karena terjadi error yang tidak terduga: " + e.getMessage());
